 ...
 *
 * @author Ashima Ashima May 26,2023 
 */
...
private static int generateRandomNumber(int min, int max) {
    ...
    private static void printInfo() {
        ...
        System.out.println("My name is Ashima, but you can call me Aish");
        System.out.println();
        
        System.out.println("My career ambitions:");
        System.out.println("-- Gain more skills in softwafre and computers");
